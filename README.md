...
- add cocktails to the game, so some customers from the 80s onwards want cocktails. make a new bar supply unit called a speed well that lets the bartender or server make cocktails. the speed well should operate in the same was as the kegerator for pathfinding and queuing. the speed well should be slower to make the cocktails but cocktails shouild sell for more money.